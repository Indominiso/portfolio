...
const Modal = ({ isOpen, setIsOpen, content }: ModalProps) => {
  ...
  return (
    <div
      className={`transition-all duration-300 ease-in-out fixed top-0 right-0 h-screen pr-[2rem] w-full px-[4.2rem] bg-black transform z-50 flex flex-col justify-between ${
